...
// coefficient (the first argument) by that new number.  For example for 3x^2, the integral would be 1x^3: we added 1
// to the exponent, and divided the coefficient by that new number).
// Notes:  The output should be a string. The coefficient and exponent is always a positive integer.
//
// ✅ SOLUTION:
